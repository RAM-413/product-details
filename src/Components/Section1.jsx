...
import redshoe from "../Images/red-shoes.png";
        ...
        <Row>
          <Col lg={6} md={12} className="my-auto">
            ...
            <div className="d-flex align-items-center justify-content-center gap-1  pt-4">
              <Row>
                <Col className="col-3">
                  <img className="w-100" src={shoe1} alt="#" />
                </Col>
                <Col className="col-3">
                  <img className="w-100" src={shoe2} alt="#" />
                </Col>
                <Col className="col-3">
                  <img className="w-100" src={shoe3} alt="#" />
                </Col>
                <Col className="col-3">
                  <img className="w-100" src={shoe4} alt="#" />
                </Col>
              </Row>
            </div>
          </Col>
          <Col lg={6} md={12} className="pt-3">
            ...
            <div className="d-flex align-items-center gap-2">
              ...
              <p className="mb-0 mt--1 pl-view-3 review ">
                ( 5 Customer Review )
              </p>
            </div>
            <p className="mt-sm-4 mt-3 mb-sm-5  main-text">
            ...
            <div className="d-flex align-items-center pb-3 pt-4 align-items-center ">
            ...
            <div class="mt-1 d-flex align-items-center mb-3">
              <label for="size" class="shoe-specs">Size:</label>
              <div class=" size-container ml-21">
                <select name="size" id="size" class="ml--12 size-container1">
            ...
            <div class="d-flex align-items-center mt-1 mb-3">
              <p class="shoe-specs">Color:</p>
              <svg class="mx-4 shoe-color" xmlns="http://www.w3.org/2000/svg" width="155" height="35"
                viewBox="0 0 155 35" fill="none">
            ...
            <div class="d-flex mt-1">
              <div class="d-flex">
                ...
                <p class="svg-text mb-0">Compare</p>
              </div>
              <div class="d-flex mx-4 px-1 mb-4">
                ...
                <p class="svg-text mt-1 mb-0">Wishlist</p>
              </div>
            </div>

            <div class="black-line my-1"></div>
            <div className="d-flex  align-items-center gap-4  ">
              <a className="sec-h" href="">
                <svg
                  width="22"
                  height="22"
                  viewBox="0 0 22 22"
              ...
              <a className="sec-h" href="https://twitter.com/" target="_blank">
                <svg
                  width="24"
                  height="19"
                  viewBox="0 0 24 19"
